...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        example1_button = gr.Button(value="วิธีการลดความอ้วน")
...
#demo.queue().launch(server_name="0.0.0.0",server_port=5000, share=share_gradio,root_path="/thaiGPT")
demo.queue(concurrency_count=2,api_open=False).launch(server_name="0.0.0.0",server_port=5000, share=share_gradio,show_api=False)
#demo.queue(concurrency_count=2).launch(server_name="0.0.0.0",server_port=5000, share=share_gradio)
